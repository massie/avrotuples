...
object AvroTuple12 {
  ...
  val SCHEMA$ = AvroTupleSchemas.SCHEMAS(11)
  val FLAT_SCHEMA = AvroTupleSchemas.FLAT_SCHEMAS(11)
...
case class AvroTuple12[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12](
    @transient var _1: T1,
    @transient var _2: T2,
    @transient var _3: T3,
    @transient var _4: T4,
  ...
  extends Product12[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12] with SpecificRecord with Externalizable {
