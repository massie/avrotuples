...
object AvroTuple5 {
  ...
  val SCHEMA$ = AvroTupleSchemas.recursiveSchemas(4)
...
final case class AvroTuple5[T1, T2, T3, T4, T5](
    @transient var _1: T1,
    @transient var _2: T2,
    @transient var _3: T3,
    @transient var _4: T4,
  ...
  override def write(kryo: Kryo, output: Output): Unit = {
    AvroTuple5.writeToOutputStream(this, output.getOutputStream)
  }

  override def read(kryo: Kryo, input: Input): Unit = {
    AvroTuple5.readFromInputStream(this, input.getInputStream)
  }
