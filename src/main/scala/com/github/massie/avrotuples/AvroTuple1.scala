...
object AvroTuple1 {
  ...
  val SCHEMA$ = AvroTupleSchemas.SCHEMAS(0)
  val FLAT_SCHEMA = AvroTupleSchemas.FLAT_SCHEMAS(0)
...
case class AvroTuple1[T1](
    @transient var _1: T1)
  extends Product1[T1] with SpecificRecord with Externalizable {
