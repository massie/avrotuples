...
object AvroTuple15 {
  ...
  val SCHEMA$ = AvroTupleSchemas.SCHEMAS(14)
  val FLAT_SCHEMA = AvroTupleSchemas.FLAT_SCHEMAS(14)
...
case class AvroTuple15[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15](
    @transient var _1: T1,
    @transient var _2: T2,
    @transient var _3: T3,
    @transient var _4: T4,
  ...
  extends Product15[T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14, T15] with SpecificRecord with Externalizable {
