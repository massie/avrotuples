...
object AvroTuple3 {
  ...
  def readFromInputStream(tuple: AvroTuple3[_, _, _], in: InputStream) = {
    AvroTuple3.reader.read(tuple, DecoderFactory.get.directBinaryDecoder(in, null))
  }

  def writeToOutputStream(tuple: AvroTuple3[_, _, _], out: OutputStream) = {
    AvroTuple3.writer.write(tuple, EncoderFactory.get.directBinaryEncoder(out, null))
  }

  def fromInputStream(in: InputStream) : AvroTuple3[_, _, _] = {
    readFromInputStream(null.asInstanceOf[AvroTuple3[_, _, _]], in)
  }

  def fromBytes(bytes: Array[Byte]): AvroTuple3[_, _, _] = {
...
final case class AvroTuple3[T1, T2, T3](
    @transient var _1: T1,
    @transient var _2: T2,
    @transient var _3: T3)
  ...
  def update(n1: T1, n2: T2, n3: T3): AvroTuple3[T1, T2, T3] = {
    _1 = n1
    _2 = n2
    _3 = n3
    this
  ...
  override def getSchema: Schema = AvroTuple3.SCHEMA$

  override def toString: String = "(" + _1 + "," + _2 + "," + _3 + ")"

  def toBytes: Array[Byte] = {
    val byteStream = new ByteArrayOutputStream()
    AvroTuple3.writeToOutputStream(this, byteStream)
    byteStream.flush()
  ...
  override def readExternal(in: ObjectInput): Unit = {
    AvroTuple3.readFromInputStream(this, ExternalizableInput(in))
  }

  override def writeExternal(out: ObjectOutput): Unit = {
    AvroTuple3.writeToOutputStream(this, ExternalizableOutput(out))
  }

  override def write(kryo: Kryo, output: Output): Unit = {
    AvroTuple3.writeToOutputStream(this, output.getOutputStream)
  }

  override def read(kryo: Kryo, input: Input): Unit = {
    AvroTuple3.readFromInputStream(this, input.getInputStream)
  }
